...
// Ініціалізація FileEncryptor V3 (безпечніша версія)
const encryptor = new FileEncryptorV3();
...
function validateEncryptForm() {
    ...
    const passwordValid = password.length >= 12;  // V3: мінімум 12 символів
...
encryptBtn.addEventListener('click', async () => {
    ...
    if (password.length < 12) {
        showResult(encryptResult, 'error', 'Пароль повинен містити мінімум 12 символів!');
        return;
    }
